asyncTest( "Player play, pause, autoplay", function() {
  ...
  pop1 = Popcorn.betterYT( "#video6", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
  ...
  pop2 = Popcorn.betterYT( "#video7", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
  ...
  pop3 = Popcorn.betterYT( "#video8", "http://www.youtube.com/watch?v=nfGV32RNkhw&autoplay=0" );
  ...
  pop4 = Popcorn.betterYT( "#video9", "http://www.youtube.com/watch?v=nfGV32RNkhw&autoplay=1" );
...
asyncTest("Update Timer", function () {
  ...
  var p2 = Popcorn.betterYT( '#video2', 'http://www.youtube.com/watch?v=nfGV32RNkhw' ),
      expects = 12,
      count   = 0,
      execCount = 0,
...
asyncTest("Plugin Factory", function () {
  ...
  var popped = Popcorn.betterYT( '#video2', 'http://www.youtube.com/watch?v=nfGV32RNkhw' ),
...
asyncTest( "Popcorn YouTube Plugin Url and Duration Tests", function() {
  ...
  var count = 0,
      expects = 3,
      popcorn = Popcorn.betterYT( '#video2', 'http://www.youtube.com/watch?v=nfGV32RNkhw' );
...
asyncTest( "Popcorn YouTube Plugin Url Regex Test", function() {
  ...
  Popcorn.forEach( urlTests, function( value, key ) {
    ...
    var urlTest = urlTests[ key ],
        popcorn = Popcorn.betterYT( "#video" + i++, urlTest.url );
...
asyncTest( "Player height and width", function() {
  ...
  var popcorn = Popcorn.betterYT( "#video4", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
...
asyncTest( "Player Errors", function() {
  ...
  var pop = Popcorn.betterYT( "#video4", "http://www.youtube.com/watch?v=abcdefghijk", {
    events: {
      error: function() {
...
asyncTest( "YouTube ended event", function() {
  ...
  var pop = Popcorn.betterYT( "#video10", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
...
asyncTest( "youtube player gets a proper _teardown", function() {
  ...
  var popcorn = Popcorn.betterYT( "#video9", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
  popcorn.on( "loadeddata", function() {
...
asyncTest( "Youtube ready state events", function() {
  ...
  popped = Popcorn.betterYT( "#video6", "http://www.youtube.com/watch?v=nfGV32RNkhw", {
    events: {
...
asyncTest( "Youtube media start time fragment", function() {
  ...
  popcorn1 = Popcorn.betterYT( "#video8", "http://www.youtube.com/watch?v=nfGV32RNkhw&start=130" );
  ...
  popcorn2 = Popcorn.betterYT( "#video9", "http://www.youtube.com/watch?v=nfGV32RNkhw&t=2m10s" );
  ...
  popcorn3 = Popcorn.betterYT( "#video10", "http://www.youtube.com/watch?v=nfGV32RNkhw&t=2m" );
  ...
  popcorn4 = Popcorn.betterYT( "#video11", "http://www.youtube.com/watch?v=nfGV32RNkhw&t=10s" );
...
asyncTest( "youtube can play type", function() {
  ...
  ok( Popcorn.betterYT.canPlayType( "div", "http://youtube.com/watch/v/6v3jsVivU6U?format=json" ), "youtube can play url in this format: http://youtube.com/watch/v/6v3jsVivU6U?format=json" );
  ok( Popcorn.betterYT.canPlayType( "div", "http://www.youtube.com/v/M3r2XDceM6A&amp;fs=1" ), "youtube can play url in this format: http://www.youtube.com/v/M3r2XDceM6A&amp;fs=1" );
  ok( Popcorn.betterYT.canPlayType( "div", "youtube.com/v/M3r2XDceM6A&fs=1" ), "youtube can play url in this format: youtube.com/v/M3r2XDceM6A&fs=1" );
  ok( Popcorn.betterYT.canPlayType( "div", "www.youtube.com/v/M3r2XDceM6A&amp;fs=1" ), "youtube can play url in this format: www.youtube.com/v/M3r2XDceM6A&amp;fs=1" );
  ok( !Popcorn.betterYT.canPlayType( "div", [ "http://www.youtube.com/v/M3r2XDceM6A&amp;fs=1", "youtube.com/v/M3r2XDceM6A&fs=1" ] ), "Youtube can't play an array of urls" );
  start();
});
